...
subprocess.check_call([sys.executable, str(patch_dir / "apply_exact_panel_runtime2_v5.py"), str(root)])
...
print('[panel-fix-v5] exact uploaded panel + brace-aware runtime applied')
